...
class BamlAsyncClient:
    ...
    async def ExtractTextFromImage(self, image: baml_py.Image,book: typing.Optional[str] = None,chapter: typing.Optional[str] = None,verse: typing.Optional[str] = None,page_number: typing.Optional[str] = None,hebrew_text: typing.Optional[str] = None,greek_text: typing.Optional[str] = None,ocr_text: typing.Optional[str] = None,
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = await self.__options.merge_options(baml_options).call_function_async(function_name="ExtractTextFromImage", args={
    ...
    async def ExtractVersesFromMarkdown(self, markdown_text: str,
        baml_options: BamlCallOptions = {},
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = await self.__options.merge_options(baml_options).call_function_async(function_name="ExtractVersesFromMarkdown", args={
                "markdown_text": markdown_text,
            })
            return typing.cast(typing.List["types.VerseChunk"], result.cast_to(types, types, stream_types, False, __runtime__))
    async def NormalizeGillMarkdown(self, raw_markdown: str,
        baml_options: BamlCallOptions = {},
    ) -> str:
        # Check if on_tick is provided
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = await self.__options.merge_options(baml_options).call_function_async(function_name="NormalizeGillMarkdown", args={
                "raw_markdown": raw_markdown,
            })
            return typing.cast(str, result.cast_to(types, types, stream_types, False, __runtime__))
    async def OptimizeSearchQuery(self, user_query: str,available_entities: typing.List[str],
        baml_options: BamlCallOptions = {},
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = await self.__options.merge_options(baml_options).call_function_async(function_name="OptimizeSearchQuery", args={
    ...
    async def RepairQuote(self, model_quote: str,source_text: str,
        baml_options: BamlCallOptions = {},
    ) -> types.RepairedQuote:
        # Check if on_tick is provided
        if 'on_tick' in baml_options:
            # Use streaming internally when on_tick is provided
            stream = self.stream.RepairQuote(model_quote=model_quote,source_text=source_text,
                baml_options=baml_options)
            return await stream.get_final_response()
        else:
            # Original non-streaming code
            result = await self.__options.merge_options(baml_options).call_function_async(function_name="RepairQuote", args={
                "model_quote": model_quote,"source_text": source_text,
            })
            return typing.cast(types.RepairedQuote, result.cast_to(types, types, stream_types, False, __runtime__))
    ...
    async def ValidateMetadataCore(self, image: baml_py.Image,ocr_metadata: types.MetadataCore,
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = await self.__options.merge_options(baml_options).call_function_async(function_name="ValidateMetadataCore", args={
    ...
    async def ValidateMetadataVerses(self, image: baml_py.Image,chapter: typing.Optional[int] = None,verse_hint: typing.Optional[str] = None,body_verses: typing.Optional[str] = None,
        baml_options: BamlCallOptions = {},
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = await self.__options.merge_options(baml_options).call_function_async(function_name="ValidateMetadataVerses", args={
    ...
    async def ValidateOCRMetadata(self, image: baml_py.Image,ocr_metadata: types.Metadata,body_verses: typing.Optional[str] = None,
        baml_options: BamlCallOptions = {},
    ) -> types.Metadata:
        # Check if on_tick is provided
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = await self.__options.merge_options(baml_options).call_function_async(function_name="ValidateOCRMetadata", args={
...
class BamlStreamClient:
    ...
    def ExtractTextFromImage(self, image: baml_py.Image,book: typing.Optional[str] = None,chapter: typing.Optional[str] = None,verse: typing.Optional[str] = None,page_number: typing.Optional[str] = None,hebrew_text: typing.Optional[str] = None,greek_text: typing.Optional[str] = None,ocr_text: typing.Optional[str] = None,
        ...
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="ExtractTextFromImage", args={
            "image": image,"book": book,"chapter": chapter,"verse": verse,"page_number": page_number,"hebrew_text": hebrew_text,"greek_text": greek_text,"ocr_text": ocr_text,
        })
    ...
    def ExtractVersesFromMarkdown(self, markdown_text: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[typing.List["stream_types.VerseChunk"], typing.List["types.VerseChunk"]]:
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="ExtractVersesFromMarkdown", args={
            "markdown_text": markdown_text,
        })
        return baml_py.BamlStream[typing.List["stream_types.VerseChunk"], typing.List["types.VerseChunk"]](
          result,
    ...
    def NormalizeGillMarkdown(self, raw_markdown: str,
        ...
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="NormalizeGillMarkdown", args={
            "raw_markdown": raw_markdown,
        })
        return baml_py.BamlStream[str, str](
          result,
    ...
    def OptimizeSearchQuery(self, user_query: str,available_entities: typing.List[str],
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[stream_types.OptimizedQuery, types.OptimizedQuery]:
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="OptimizeSearchQuery", args={
            "user_query": user_query,"available_entities": available_entities,
        })
        return baml_py.BamlStream[stream_types.OptimizedQuery, types.OptimizedQuery](
          result,
    ...
    def RepairQuote(self, model_quote: str,source_text: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[stream_types.RepairedQuote, types.RepairedQuote]:
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="RepairQuote", args={
            "model_quote": model_quote,"source_text": source_text,
        })
        return baml_py.BamlStream[stream_types.RepairedQuote, types.RepairedQuote](
          result,
          lambda x: typing.cast(stream_types.RepairedQuote, x.cast_to(types, types, stream_types, True, __runtime__)),
          lambda x: typing.cast(types.RepairedQuote, x.cast_to(types, types, stream_types, False, __runtime__)),
          ctx,
        )
    ...
    def ValidateMetadataCore(self, image: baml_py.Image,ocr_metadata: types.MetadataCore,
        ...
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="ValidateMetadataCore", args={
            "image": image,"ocr_metadata": ocr_metadata,
        })
        return baml_py.BamlStream[stream_types.MetadataCore, types.MetadataCore](
          result,
    ...
    def ValidateMetadataVerses(self, image: baml_py.Image,chapter: typing.Optional[int] = None,verse_hint: typing.Optional[str] = None,body_verses: typing.Optional[str] = None,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[stream_types.MetadataVerses, types.MetadataVerses]:
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="ValidateMetadataVerses", args={
            "image": image,"chapter": chapter,"verse_hint": verse_hint,"body_verses": body_verses,
        })
        return baml_py.BamlStream[stream_types.MetadataVerses, types.MetadataVerses](
          result,
    ...
    def ValidateOCRMetadata(self, image: baml_py.Image,ocr_metadata: types.Metadata,body_verses: typing.Optional[str] = None,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[stream_types.Metadata, types.Metadata]:
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="ValidateOCRMetadata", args={
            "image": image,"ocr_metadata": ocr_metadata,"body_verses": body_verses,
        })
        return baml_py.BamlStream[stream_types.Metadata, types.Metadata](
          result,
...
class BamlHttpRequestClient:
    ...
    async def ExtractTextFromImage(self, image: baml_py.Image,book: typing.Optional[str] = None,chapter: typing.Optional[str] = None,verse: typing.Optional[str] = None,page_number: typing.Optional[str] = None,hebrew_text: typing.Optional[str] = None,greek_text: typing.Optional[str] = None,ocr_text: typing.Optional[str] = None,
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="ExtractTextFromImage", args={
            "image": image,"book": book,"chapter": chapter,"verse": verse,"page_number": page_number,"hebrew_text": hebrew_text,"greek_text": greek_text,"ocr_text": ocr_text,
        }, mode="request")
        return result
    async def ExtractVersesFromMarkdown(self, markdown_text: str,
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="ExtractVersesFromMarkdown", args={
            "markdown_text": markdown_text,
        }, mode="request")
        return result
    async def NormalizeGillMarkdown(self, raw_markdown: str,
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="NormalizeGillMarkdown", args={
            "raw_markdown": raw_markdown,
        }, mode="request")
        return result
    async def OptimizeSearchQuery(self, user_query: str,available_entities: typing.List[str],
    ...
    async def RepairQuote(self, model_quote: str,source_text: str,
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="RepairQuote", args={
            "model_quote": model_quote,"source_text": source_text,
        }, mode="request")
        return result
    async def ResolveBoundaryPronouns(self, unresolved_text: str,previous_text: str,previous_entities: typing.List[str],
    ...
    async def ValidateMetadataCore(self, image: baml_py.Image,ocr_metadata: types.MetadataCore,
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="ValidateMetadataCore", args={
            "image": image,"ocr_metadata": ocr_metadata,
        }, mode="request")
        return result
    async def ValidateMetadataVerses(self, image: baml_py.Image,chapter: typing.Optional[int] = None,verse_hint: typing.Optional[str] = None,body_verses: typing.Optional[str] = None,
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="ValidateMetadataVerses", args={
            "image": image,"chapter": chapter,"verse_hint": verse_hint,"body_verses": body_verses,
        }, mode="request")
        return result
    async def ValidateOCRMetadata(self, image: baml_py.Image,ocr_metadata: types.Metadata,body_verses: typing.Optional[str] = None,
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="ValidateOCRMetadata", args={
            "image": image,"ocr_metadata": ocr_metadata,"body_verses": body_verses,
        }, mode="request")
        return result
