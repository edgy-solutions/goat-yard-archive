...
class BamlAsyncClient:
    ...
    async def NormalizeGillMarkdown(self, raw_markdown: str,
        ...
        if 'on_tick' in baml_options:
            ...
            return typing.cast(str, result.cast_to(types, types, stream_types, False, __runtime__))
    async def ValidateOCRMetadata(self, image: baml_py.Image,ocr_metadata: types.Metadata,
        baml_options: BamlCallOptions = {},
    ) -> types.Metadata:
        # Check if on_tick is provided
        if 'on_tick' in baml_options:
            # Use streaming internally when on_tick is provided
            stream = self.stream.ValidateOCRMetadata(image=image,ocr_metadata=ocr_metadata,
                baml_options=baml_options)
            return await stream.get_final_response()
        else:
            # Original non-streaming code
...
class BamlStreamClient:
    ...
    def ExtractGillKnowledge(self, commentary_text: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[typing.List["stream_types.GillEntity"], typing.List["types.GillEntity"]]:
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="ExtractGillKnowledge", args={
            "commentary_text": commentary_text,
        })
        return baml_py.BamlStream[typing.List["stream_types.GillEntity"], typing.List["types.GillEntity"]](
          result,
